...
declare namespace _ {
  ...
  interface LoDashImplicitObjectWrapper<T> {
     ...
     */
    difference<TValue>(
      ...values: Array<TValue[] | List<TValue>>
  ...
  interface LoDashImplicitArrayWrapper<T> {
    ...
    intersection<TResult>(
      ...arrays: Array<TResult[] | List<TResult>>
  ...
  interface LoDashStatic {
     ...
     */
    pullAt<T>(array: List<T>, ...indexes: Array<number | number[]>): T[];
  }
  ...
  interface LoDashStatic {
     ...
     **/
    findWhere<W, T>(collection: T[], whereValue: W): T | undefined;
     ...
     **/
    findWhere<T>(collection: T[], pluckValue: string): T | undefined;
  ...
  interface LoDashStatic {
     ...
     **/
    findLast<W, T>(collection: T[], whereValue: W): T | undefined;
     ...
     **/
    findLast<T>(collection: T[], pluckValue: string): T | undefined;
  ...
  interface LoDashStatic {
    ...
    sortByOrder<W extends Object, T>(
      ...
      iteratees:
        ...
        | string
        | W
        | Array<ListIterator<T, any> | string | W>,
    ...
    sortByOrder<T>(
      ...
      iteratees:
        ...
        | string
        | Object
        | Array<ListIterator<T, any> | string | Object>,
      orders?: boolean | string | Array<boolean | string>,
    ): T[];
    ...
    sortByOrder<W extends Object, T>(
      ...
      iteratees:
        ...
        | string
        | W
        | Array<NumericDictionaryIterator<T, any> | string | W>,
      orders?: boolean | string | Array<boolean | string>,
    ): T[];
    ...
    sortByOrder<T>(
      ...
      iteratees:
        ...
        | string
        | Object
        | Array<NumericDictionaryIterator<T, any> | string | Object>,
      orders?: boolean | string | Array<boolean | string>,
    ): T[];
    ...
    sortByOrder<W extends Object, T>(
      ...
      iteratees:
        ...
        | string
        | W
        | Array<DictionaryIterator<T, any> | string | W>,
      orders?: boolean | string | Array<boolean | string>,
    ): T[];
    ...
    sortByOrder<T>(
      ...
      iteratees:
        ...
        | string
        | Object
        | Array<DictionaryIterator<T, any> | string | Object>,
      orders?: boolean | string | Array<boolean | string>,
    ): T[];
  }
  ...
  interface LoDashImplicitWrapper<T> {
    ...
    sortByOrder(
      iteratees:
        | ListIterator<T, any>
        | string
        | Array<ListIterator<T, any> | string>,
      orders?: boolean | string | Array<boolean | string>,
    ): LoDashImplicitArrayWrapper<T>;
  }
  ...
  interface LoDashStatic {
     ...
     **/
    where<T, U extends {}>(list: T[], properties: U): T[];
  ...
  interface LoDashStatic {
     ...
     * @see _.defaults
     */
    defaults<TResult extends {}>(object: {}, ...sources: Array<{}>): TResult;
  }
